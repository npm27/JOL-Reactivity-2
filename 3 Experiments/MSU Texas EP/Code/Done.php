 ...
 */
    ...
    if ($_CONFIG->next_experiment == false) {
        $title   = 'Done!';
        $message = '<h2>Thank you for your participation! Please make a note right now of the exact time/date you completed this study. You will will need this information to claim your credit!</h2>'
